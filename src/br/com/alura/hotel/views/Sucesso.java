...
public class Sucesso extends JDialog {
	...
	public Sucesso() {
		setIconImage(
				Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("/imagens/logo-hotel-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("/imagens/logo-hotel-100px.png")));
